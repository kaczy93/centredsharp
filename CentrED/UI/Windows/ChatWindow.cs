...
public class ChatWindow : Window
{
    ...
    public ChatWindow()
    {
        Application.CEDClient.ChatMessage += (user, message) => ChatMessages.Add(new ChatMessage(user, message, DateTime.Now));
    ...
    protected override void InternalDraw()
    {
        ...
        ImGui.BeginChild("Client List", new System.Numerics.Vector2(Math.Max(150, maxNameSize), 0), ImGuiChildFlags.Border);
        ImGui.Text("Clients");
        ImGui.Separator();
        ...
        else
        {
            ...
            ImGui.SetCursorPosY(inputPosY - ImGui.GetTextLineHeightWithSpacing());
            foreach (var message in ChatMessages.Reverse<ChatMessage>())
            {
