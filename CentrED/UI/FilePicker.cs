...
{
    static readonly Dictionary<object, FilePicker> _filePickers = new();
    ...
    public static FilePicker GetFolderPicker(object o, string startingPath) => GetFilePicker
        (o, startingPath, null, true);

    public static FilePicker GetFilePicker
        (object o, string startingPath, string searchFilter = null, bool onlyAllowFolders = false)
    {
        ...
        if (!_filePickers.TryGetValue(o, out FilePicker fp))
        {
            ...
            if (searchFilter != null)
            {
                ...
                fp.AllowedExtensions.AddRange
                    (searchFilter.Split(new char[] { '|' }, StringSplitOptions.RemoveEmptyEntries));
            }
